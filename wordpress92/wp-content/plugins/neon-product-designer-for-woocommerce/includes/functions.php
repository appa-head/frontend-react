...
function npd_init_canvas_vars( $npc_metas, $product, $editor, $skin ) {
	...
	$output_settings = vc_get_proper_value( $npc_metas, 'output-settings', array() );

	$designer_unit = vc_get_proper_value( $npc_metas, 'unit', 'cm' );
	$font_behaviour = vc_get_proper_value( $npc_metas, 'font-bahaviour', 'select' );
	$default_color = vc_get_proper_value( $npc_metas, 'font-bahaviour', '#ffffff' );
	$default_color_behaviour = vc_get_proper_value( $npc_metas, 'data-color-behaviour', 'light-color' );
	...
	$disable_shortcut = vc_get_proper_value( $general_options, 'disable-keyboard-shortcuts', 0 );
