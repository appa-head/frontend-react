		...
		if ( 'add' === $action ) {
			if ( $font_label ) {
				...
				if ( empty( $fonts ) ) {
					...
					$font_labels = array_map( create_function( '$vc', 'return $vc[0];' ), $fonts );
					...
					<tr class="form-field">
						...
						<td>
							<div>
								...
								<div><a class='vc-add-font-file button'><?php esc_html_e( 'Add font file', 'neon-product-designer' ); ?></a><br>
					...
					<div class="form-wrap">
						...
						<form action="admin.php?page=npd-manage-fonts&amp;noheader=true" method="post">
							...
							<div class="form-field">
								...
								<div>
									<div>
										<a class='vc-add-font-file button'><?php esc_html_e( 'Add font file', 'neon-product-designer' ); ?></a><br>
										<span style="color:red;"><?php esc_html_e( 'Make sure you select at least one style per file.', 'neon-product-designer' ); ?></span>
									</div>
									<table class="font_style_table">
										<thead>
			...
			if ( ! empty( $fonts_styles ) ) :
				...
				$tpl .= " </ul> 
                           ...
                           <td id='file_data_$key'>
                               <button class='button vc-remove-font-file' data-selector='file_container_$key'>" . __( 'Remove font', 'neon-product-designer' ) . "</button>
		...
		$tpl = "<tr>
                 <td>
                    ...
                    <td id='file_data_{index}'>
                        <button class='button vc-remove-font-file' data-selector='file_container_{index}'>" . __( 'Remove font', 'neon-product-designer' ) . "</button>
