...
class NPD_Editor {
	...
	public function get_editor() {
		...
		$ui_options = vc_get_proper_value( $npd_settings, 'npd-ui-options', array() );
		$skin       = apply_filters( 'npd_loaded_skin', vc_get_proper_value( $ui_options, 'skin', 'NPD_Skin_Default' ) );
