...
class NPD_Config {
	...
	*/
	...
	public function get_color_settings() {
		...
		$color_behaviour_options =  array('light-color' => __( 'Ligth Color', 'neon-product-designer' ), 
										  'same-color' => __( 'Same Color', 'neon-product-designer' ),
										  'txt-color' => __( 'Text Color', 'neon-product-designer'),
										   );
	...
	private function get_product_tab_row( $pid, $configs_ids, $title ) {
		...
		echo "<div class='npd-product-config-row'>" . vc_admin_fields( $settings ) . '</div>';
	}
